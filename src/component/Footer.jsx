      ...
      <div className={`max-w-[1200px] h-max rounded-t-2xl flex justify-center items-center backdrop-blur-sm ${mode === true ? 'bg-background-white text-black' : 'bg-background-dark text-white'}`}>
        ...
        <div className='hidden md:block '>                   
            <div className={`flex flex-col text-center`}>            
                ...
                <p className='text-base mb-3 font-bold'>&copy; {new Date().getFullYear()}, João Vitor Tadeo. All Rights Reserved.</p>
            </div>
        </div>
        {/*Smarthphone size*/}
        <div className='block md:hidden'>
            <div className='flex flex-col text-center'>
                ...
                <p className='text-base'>&copy; {new Date().getFullYear()}, João Vitor Tadeo. All Rights Reserved.</p>
            </div>
        </div>
    </div>
    </div>
