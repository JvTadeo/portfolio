    ...
    <div className={`max-w-[1200px] h-[500px] rounded-2xl flex justify-center items-center backdrop-blur-sm ${mode === true ? 'bg-background-white': 'bg-background-dark'}`}>
        ...
        <div className='hidden md:block md:mx-8'>      
          <div className='flex flex-row font-roboto items-center justify-center'>
            ...
            <div>
              <img className='object-cover object-center rounded-2xl w-[290px] h-[380px] drop-shadow-lg ' src={profile_smallsize}></img>  
            </div>
          </div>
        </div>
        {/*Smarthphone size*/}
        <div className='block md:hidden w-screen'>
          <div className='flex flex-col items-center font-roboto'>
            <img className='object-cover object-center rounded-2xl w-[193px] h-[250px] drop-shadow-lg ' src={profile_smallsize}></img>
